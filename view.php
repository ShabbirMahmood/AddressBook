                    ...
                    <table id="example" class="display" cellspacing="0" width="100%">
                        ...
                        while( $rows = mysqli_fetch_array($result))   // mysqli *** Spelling is important
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                    <form  action="removeContract.php" method="post" style="" >
                                        <button id="remove_btn"  value="<?php echo $rows['id']; ?>" type="submit" name="delete_contract" class="btn btn-danger"><span class="glyphicon glyphicon-remove-circle"></span></button>
                                    </form>
                                </td>
                            </tr>

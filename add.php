  ...
  if (!isset($_SESSION['name'])) {
   ...
   if (isset($_GET['logout'])) {
    ...
    if(isset($_POST['save'])) {
        ...
        $query = "INSERT INTO contact_tb (user_id, full_name, nick_name, birth_date, address, email, contact_number) VALUES ('$user_id', '$full_name', '$nick_name', '$birth_date', '$address', '$email', '$contact_number' )";
